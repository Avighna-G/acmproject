  ...
  <h1>Memberships
    ...
    <div>
        ...
        ACM is not about an individual, it is a family of 820+ members. Our members are as important to us as the people who lead us. Anyone who is driven by the zeal to learn something, to make their place in this tech world can come and join us. All the ACM members are entitled to all the events ACM conducts like coding contests, trainings on trending technologies, hackathons, quiz contests and many more. All the members also get the latest tech news to their mails so that they are up to date on the recent technological advancements.
         <br/><Link className='flex items-center underline hover:no-underline text-blue-600 hover:text-blue-800 visited:text-purple-600' to="/memberships">Join as a member < BsBoxArrowUpRight className='icon-style'/> </Link>   
        </p>
    </div>
    </div>
...
Technical team, Events and PR team, Social Media team, Design team and Coding team. Be it any event, our volunteers are our strength that make the event successful. Together, we celebrate our success; these teams work as pillars for ACM. By helping each other and appreciating others work, Team ACM moves forward.
<br/><Link className='flex items-center underline hover:no-underline text-blue-600 hover:text-blue-800 visited:text-purple-600' to="/memberships">See our Team < BsBoxArrowUpRight className='icon-style'/> </Link> 
        </p>
    </div>
    </div>
